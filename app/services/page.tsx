...
export const metadata: Metadata = {
  title: "Services",
  description:
    "Multiple services, one partner: customer acquisition, back-office support, talent, marketing, software development, AI and automation, application development, and cloud for US businesses.",
};
